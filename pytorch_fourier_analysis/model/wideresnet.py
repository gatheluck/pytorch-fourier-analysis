...
__all__ = ["WideResNet", "wideresnet16", "wideresnet28", "wideresnet40"]
...
def wideresnet16(
    ...
    Args
        ...
        widening_factor: This number decide width of model which is represented by k in original paper.
        droprate: Probability of dropout.
    """
